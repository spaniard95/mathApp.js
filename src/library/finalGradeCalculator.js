...
const finalGradeCalculator = (passedLessons, grades) => {
  const [numanator, denominator] = passedLessons.reduce(
    (franctionAccumulator, lesson) => {
      let syntelestis;
      ...
      return [num + syntelestis * grades[lesson.number], den + syntelestis];
    },
    [0, 0]
  );
